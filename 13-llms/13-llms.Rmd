---
title: "13 - Using Large Language Models"
...
```
_Source_: Bing image generator ("a huge pile of book")
]
...
- **Text Segmentation:** Breaks down text into chunks called tokens.
...
---
# Understanding Your Model Parameters
...
.pull-left[
- ChatGPR have proofread and edited this presentation, which is written using the R [`Xaringan`](https://github.com/yihui/xaringan) package. 
...
knitr::include_graphics("figs/editingxar.png")
...
.pull-left[
Prompt: `"Draw an aggregate supply and demand graph using the TikZ package."`
]
.pull-right[
```{r echo=FALSE, out.width = "90%", fig.align='center'}
...
Prompt: `Translate the following STATA code to R`
...
---
# Intriguing Topics Yet to Explore
...
# So, is it just adding one word at a time...?
