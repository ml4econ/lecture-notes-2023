...
subtitle: "Exploring Large Language Models"
author: "Itamar Caspi"
...
.pull-left[
The new wave of AI extends beyond language models:
...
- **Regulation**: How to treat AIs? e.g., "robo-advisors".
]
...
---
# Tip: Extracting Text and Equations from Every Document
...
- ChatGPT have proofread and edited this presentation, which is written using the R [`Xaringan`](https://github.com/yihui/xaringan) package. For example, I've used the following prompt:
...
.pull-left[
- Translation (Google/Bing translate from Hebrew -> edit with ChatGPT)
...
---
# Getting Serious 2: ChatGPT Plugins

.pull-left[
- ChatGPT plugins are "agents" that enhance the fundamental capabilities of ChatGPT.

- OpenAI provides "Native" plugins which offer features like web browsing and code interpretation.

- Additionally, there are over 100 third-party plugins available and that number continues to grow.

- For research: [Wolfram]() for doing math, [AskYourPDF]() for handling long documents, and [ScholarAI]() for conducting literature reviews.
]
.pull-right[
```{r echo=FALSE, out.width = "100%", fig.align='center'}
...
---
# Putting it all together: boiGPT Interest Rate Decision

[Introducing "boiGPT"!](https://chat.openai.com/share/c3268915-8795-47e1-a81a-aa3641a5576b)
...
---
# Can We Measure the Benefits or Costs?
